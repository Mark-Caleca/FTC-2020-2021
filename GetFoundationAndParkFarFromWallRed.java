...
@Autonomous(name="GetFoundationAndParkFarFromWallRed", group="Autonomous")

public class GetFoundationAndParkFarFromWallRed extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        robot.mecanumStrafe(0.5, 10,MovementDirection.RIGHT, -90); //48 30 y: -24 -24
